...
public class Day21Part2 {
	...
	public static void main (String [] args) throws IOException {
		...
		String s = "fbgdceah";	// ending string
		
		for (int i = lines.size() - 1; i >= 0; i--) {  // read backwards through the instructions
			...
			} else if (tokens[0].equals("rotate")) {   // NOTE: the rotate method reverses the direction for part 2
